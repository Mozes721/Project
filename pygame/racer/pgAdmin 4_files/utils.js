  ...
  pgBrowser.utils = {
    ...
    addMenus: function (obj) {
      ...
      if (this.counter.total == this.counter.loaded) {
          ...
          url: "/help/help/index.html?ver=40300",
          target: "pgadmin_help",
          icon: 'fa fa-question',
